...
from model.sam import GSAMVisionEncoder,GSAMPromptEncoder, GSAMMaskDecoder, GSAMBase
...
vision_encoder = GSAMVisionEncoder(hf_pretrain_name=hf_name, device=device)
prompt_encoder = GSAMPromptEncoder(hf_pretrain_name=hf_name, device=device)
mask_decoder = GSAMMaskDecoder(hf_pretrain_name=hf_name, device=device)
