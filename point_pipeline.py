...
def process_single_image(img_path, point_model, sam_model, sam_processor, save_dir, save_vis=True):
...
def main():
    parser = argparse.ArgumentParser(description='Process images with point detection and SAM')
    parser.add_argument('--img-dir', type=str, required=True, help='Directory containing input images')
    parser.add_argument('--point-ckpt', type=str, 
    ...
    parser.add_argument('--save-vis', action='store_true', help='Save visualization results')
